        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                <div class="quick_view_slide">
                    <div class="single_view_slide"><a href="{{ asset('frontend_asset') }}/{{ $product_details->gallary }}"
                            data-lightbox="roadtrip" class="d-block mb-4"><img
                                src="{{ asset('frontend_asset') }}/img/product/4.jpg" class="img-fluid rounded"
                                alt="" /></a></div>
                    <div class="single_view_slide"><a href="{{ asset('frontend_asset') }}/img/product/6-a.jpg"
                            data-lightbox="roadtrip" class="d-block mb-4"><img
                                src="{{ asset('frontend_asset') }}/img/product/6-a.jpg" class="img-fluid rounded"
                                alt="" /></a></div>
                    <div class="single_view_slide"><a href="{{ asset('frontend_asset') }}/img/product/7.jpg"
                            data-lightbox="roadtrip" class="d-block mb-4"><img
                                src="{{ asset('frontend_asset') }}/img/product/7.jpg" class="img-fluid rounded"
                                alt="" /></a></div>
                    <div class="single_view_slide"><a href="{{ asset('frontend_asset') }}/img/product/7-a.jpg"
                            data-lightbox="roadtrip" class="d-block mb-4"><img
                                src="{{ asset('frontend_asset') }}/img/product/7-a.jpg" class="img-fluid rounded"
                                alt="" /></a></div>
                </div>
            </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <div class="description_info">
                            <p class="p-0 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                                nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                                irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                                pariatur.</p>
                            <p class="p-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        <div class="reviews_info">
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="{{ asset('frontend_asset') }}/img/team-1.jpg"
                            ...
                            <!-- Single Review -->
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="{{ asset('frontend_asset') }}/img/team-2.jpg"
                                        class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
                            ...
                            <!-- Single Review -->
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="{{ asset('frontend_asset') }}/img/team-3.jpg"
                                        class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
                            ...
                            <div class="single_rev d-flex align-items-start py-3">
                                <div class="single_rev_thumb"><img src="{{ asset('frontend_asset') }}/img/team-4.jpg"
                                        class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/16.png"
                                            alt="..."></a>
                                </div>
                            </div>
                        ...
                        <div class="product_grid card b-0 mb-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/17.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/18.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/19.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/20.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/21.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top"
                                            src="{{ asset('frontend_asset') }}/img/product/22.png"
                                            alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
...
{{-- {{ $product_details->rel_to_gallarey(); }} --}}