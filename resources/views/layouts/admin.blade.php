...
<head>
	...
	<title>Jannat Reduan Dashboard</title>
	<!-- core:css -->
  ...
  <style>
    /* sub category table hover style */
      .table-hover tbody tr:hover
        ...
        /* summer note editor custome css */
        .note-editable {
          min-height: 200px; /* Set a minimum height */
          height: auto; /* Allow height to adjust based on content */
          max-height: 500px; /* Set a maximum height to prevent excessive expansion */
	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('add.tag') }}" class="nav-link">
              <i class="link-icon" data-feather="message-square"></i>
              <span class="link-title">Tag Genarate</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('product.variant') }}" class="nav-link">Add Variant</a>
                </li>
              </ul>
            </div>
          </li>
		...
		<div class="page-wrapper">
			...
			<nav class="navbar">
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-es" title="es" id="es"></i> <span class="ml-1"> Spanish </span></a>
                  ...
                  <img src="{{ asset('uploads/Users/defult_Profile.jpeg') }}"  alt="profile">
                @else
                ...
                @endif
                    ...
                    <img src="{{ asset('uploads/Users/defult_Profile.jpeg') }}"  alt="profile">
                  @else
                     <img src="{{ asset('uploads/Users/') }}/{{ Auth::User()->photo }}" alt=""  class="rounded-circle" style="width: 30%; border-radius: 50%; margin-left: 35%;">
                  @endif
